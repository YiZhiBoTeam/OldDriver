...
public class RankMonthFragment extends Fragment {
    ...
    private String path1 = "http://appgw.yizhibo.tv/v2/assetsranklist?count=20&start=0&type=monthsend&sessionid=YI21w4MONbs0nPYUl2NPZSp2FLcPypw9";
    private String path2 = "http://appgw.yizhibo.tv/v2/assetsranklist?count=20&start=0&type=monthreceive&sessionid=YI21w4MONbs0nPYUl2NPZSp2FLcPypw9";
