 ...
 */
public class FriendAdapterHong extends BaseAdapter {

    private Context context;
    private List<WeekHong.RetinfoBean.ReceiveRankListBean> list;

    public FriendAdapterHong(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<WeekHong.RetinfoBean.ReceiveRankListBean> list) {
        this.list = list;
        notifyDataSetChanged();
    }

    public void addList(List<WeekHong.RetinfoBean.ReceiveRankListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        WeekHong.RetinfoBean.ReceiveRankListBean week = (WeekHong.RetinfoBean.ReceiveRankListBean) getItem(position);

        viewHolder.tv1_item_friend.setText(position+1+"");
        viewHolder.nickname.setText(week.getNickname());
        viewHolder.costecoin.setText("获得饭团 "+week.getAccumriceroll());
